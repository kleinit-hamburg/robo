...
- zwei Raupenannahmen für die weitere Mechanikprüfung:
  - `tracked_overrow_high_clearance`: hohe Bodenfreiheit, Ketten in den Furchen, Rumpf über der Kulturreihe,
  - `tracked_inrow_narrow`: schmale Fahrgassenvariante für Wege zwischen 62-cm-Reihen.

## Mechanische Interpretation

Die hohe Variante ist kein fertiger Entwurf, sondern eine Prüfhypothese: etwa 72 cm Spurweite zwischen den Kettenmitten, schmale 12-cm-Ketten und 48 cm nominale Unterbodenfreiheit. Damit können wir prüfen, ob ein Roboter eine Kartoffelreihe überbrücken kann, ohne den Damm oder das Kraut ständig zu berühren.
